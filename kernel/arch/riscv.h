...
__attribute__((always_inline)) static inline auto w_menvcfg(uint64_t x) -> void {
  asm volatile("csrw 0x30a, %0" : : "r"(x));
}

__attribute__((always_inline)) static inline auto w_mcounteren(uint64_t x) -> void {
...
__attribute__((always_inline)) static inline auto w_mstatus(uint64_t value) -> void {
  asm volatile("csrw mstatus, %0" : : "r"(value));
};

__attribute__((always_inline)) static inline auto w_mepc(uint64_t addr) -> void {
  asm volatile("csrw mepc, %0" : : "r"(addr));
};

__attribute__((always_inline)) static inline auto w_satp(uint64_t value) -> void {
...
__attribute__((always_inline)) static inline auto w_medeleg(uint64_t value) -> void {
  asm volatile("csrw medeleg, %0" : : "r"(value));
};

__attribute__((always_inline)) static inline auto w_mideleg(uint64_t value) -> void {
  asm volatile("csrw mideleg, %0" : : "r"(value));
};

__attribute__((always_inline)) static inline auto w_pmpaddr0(uint64_t value) -> void {
  asm volatile("csrw pmpaddr0, %0" : : "r"(value));
};
__attribute__((always_inline)) static inline auto w_pmpcfg0(uint64_t value) -> void {
...
__attribute__((always_inline)) static inline auto w_sie(uint64_t value) -> void {
...
__attribute__((always_inline)) static inline auto w_stvec(uint64_t value) -> void {
  asm volatile("csrw stvec, %0" : : "r"(value));
};

__attribute__((always_inline)) static inline auto w_sstatus(uint64_t value) -> void {
...
__attribute__((always_inline)) static inline auto w_stimecmp(uint64_t x) -> void {
...
__attribute__((always_inline)) static inline auto PG_ROUND_UP(uint64_t addr) -> uint64_t {
  return (addr + PGSIZE - 1) & ~(PGSIZE - 1);
};
__attribute__((always_inline)) static inline auto PG_ROUND_DOWN(uint64_t addr) -> uint64_t {
  return (addr) & ~(PGSIZE - 1);
};

__attribute__((always_inline)) static inline auto PTE2PA(uint64_t pte) -> uint64_t {
  return (pte >> 10U) << 12U;
};
__attribute__((always_inline)) static inline auto PA2PTE(uint64_t pa) -> uint64_t {
  return (pa >> 12U) << 10U;
};

__attribute__((always_inline)) static inline auto PTE_FLAGS(uint64_t pte) -> uint64_t {
  return pte & 1023U;  // (1023)_10 == (11,1111,1111)_2
};

constexpr uint32_t PX_MASK{0x1FF};
constexpr uint32_t PG_SHIFT{12};
__attribute__((always_inline)) static inline auto PX_SHIFT(uint32_t level) -> uint64_t {
  return PG_SHIFT + 9 * level;
};
__attribute__((always_inline)) static inline auto PX(uint32_t level, uint64_t pte) -> uint64_t {
...
static inline auto MAKE_SATP(uint64_t* pagetable) {
  return SATP_SV39 | ((uint64_t)pagetable >> 12U);
};

__attribute__((always_inline)) static inline auto intr_on() -> void { w_sstatus(r_sstatus() | SSTATUS_SIE); }

__attribute__((always_inline)) static inline auto intr_off() -> void { w_sstatus(r_sstatus() & ~SSTATUS_SIE); }
